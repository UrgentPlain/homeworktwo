        ...
        child: Column(
          children: [
            ...
            Padding(
              ...
              child: Row(
                children: [
                  Expanded(child: CategoryButton(name: 'All Topic Available',image: 'assets/image/letter.png')),
                  SizedBox(width: 30.0),
                  Expanded(child: CategoryButton(name: 'Personlized Coaching',image: 'assets/image/presentation.png')),
                ],
              ),
            ),
